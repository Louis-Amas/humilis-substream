...
pub mod erc20 {
    ...
    impl ::core::convert::From<DepositFilter> for ERC20Events {
    ...
    impl ::core::convert::From<WithdrawalFilter> for ERC20Events {
    ...
    impl ::core::convert::From<RedeemCall> for ERC20Calls {
